...
module.exports = (app) => {
	...
	app.all('/hackathon-user/:version/:controller/:method', validator, router)
	app.all('/hackathon-user/:version/:controller/:file/:method', validator, router)
	app.all('/hackathon-user/:version/:controller/:method/:id', validator, router)
	app.all('/hackathon-user/:version/:controller/:file/:method/:id', validator, router)
